...
namespace P512FiorelloBack.Migrations
{
    ...
    [Migration("20220314224118_createCommentTableAndEdit")]
    partial class createCommentTableAndEdit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P512FiorelloBack.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("P512FiorelloBack.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("P512FiorelloBack.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("P512FiorelloBack.Models.Comment", b =>
                {
                    ...
                    b.HasOne("P512FiorelloBack.Models.User", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId");
                });
